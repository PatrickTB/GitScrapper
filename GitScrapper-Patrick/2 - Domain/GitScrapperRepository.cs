...
{
    public class GitScrapperRepository : IGitScrapperRepository
    {
        public IList<string> foldersUrl;
        List<Domain.FileInfo> githubFileInfos;
        public GitScrapperRepository()
        {
            this.githubFileInfos = new List<Domain.FileInfo>();
        }

        public List<Domain.FileInfo> ScrapGitHubUrl(string url)
        {
            try
            {
        ...
        public Domain.FileInfo LoadFileData(string url)
        {
            try
            {
                ...
                return new Domain.FileInfo(archiveName, url, extension, size, lines);
            }
            catch (Exception e)
            {
                throw e;
